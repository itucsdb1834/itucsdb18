...
class User:
    ...
    def save_to_db(self):
        with ConnectionPool() as cursor:
            cursor.execute('INSERT INTO user_table(firstname, lastname, username, email, passwrd) VALUES(%s,%s,%s,%s,%s)', (self.first_name, self.surname, self.username, self.email, self.password))
